...
-- Czas generowania: 03 Gru 2017, 15:46
...
--
-- Struktura tabeli dla tabeli `eagle_data`
--

CREATE TABLE `eagle_data` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Indexes for table `eagle_data`
--
ALTER TABLE `eagle_data`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT dla tabeli `eagle_data`
--
ALTER TABLE `eagle_data`
